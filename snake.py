...
def draw(surf: pygame.Surface):
    ...
    pygame.draw.rect(surf, snakeheadcolor, pygame.Rect(headcoord_x, headcoord_y, tilesize_x, tilesize_y))
    
    # draw tail
    for tailcoord in tail:
        tailcoord_x, tailcoord_y = pixelcoord_in_playfield(tailcoord)
        pygame.draw.rect(surf, snaketailcolor, pygame.Rect(tailcoord_x, tailcoord_y, tilesize_x, tilesize_y))